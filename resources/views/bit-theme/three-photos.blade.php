<section class="overflow-hidden text-gray-700 body-font">
    <div class="container flex flex-col items-center py-4 mx-auto md:flex-row">
        <div class="flex flex-wrap -m-1 md:-m-2 px-5">
            @foreach($bit->getMedia() as $media)
                <div class="w-full mt-6 lg:w-1/3 lg:pl-5 lg:pr-5 lg:py-3 lg:mt-0">
